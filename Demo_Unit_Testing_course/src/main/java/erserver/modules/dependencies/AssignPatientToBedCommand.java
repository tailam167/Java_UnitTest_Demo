...
public class AssignPatientToBedCommand {
   ...
   private InboundPatientController inboundPatientSource;

   public AssignPatientToBedCommand(StaffAssignmentManager staffAssignmentManager, InboundPatientController inboundPatientSource) {
