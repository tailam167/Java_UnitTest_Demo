...
public class DivergenceReportBuilderTest {
    ...
    public void testReport() {
        DivergenceReportBuilder reportBuilder = new DivergenceReportBuilder(1, 2,
                4, new int[]{3, 5}, new int[]{3, 8}, 10, 4);
        Assert.assertEquals(expectedReport, reportBuilder.buildReport());
    }
}